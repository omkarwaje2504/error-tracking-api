export const PRIORITY_META = {
    low: { label: 'Low', className: 'bg-neutral-500/15 text-neutral-500', iconClassName: 'text-neutral-400' },
    medium: { label: 'Medium', className: 'bg-blue-500/15 text-blue-500', iconClassName: 'text-blue-500' },
    high: { label: 'High', className: 'bg-amber-500/15 text-amber-500', iconClassName: 'text-amber-500' },
    urgent: { label: 'Urgent', className: 'bg-red-500/15 text-red-500', iconClassName: 'text-red-500' },
};
